...
class Metaclass_RobotStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'aqua_interfaces.msg.RobotStatus')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'DISCHARGED': cls.__constants['DISCHARGED'],
        }
    ...
    def RUNNING(self):
        ...
        return Metaclass_RobotStatus.__constants['RUNNING']

    @property
    def PAUSED(self):
        """Message constant 'PAUSED'."""
        return Metaclass_RobotStatus.__constants['PAUSED']

    @property
    def DISCHARGED(self):
        """Message constant 'DISCHARGED'."""
        return Metaclass_RobotStatus.__constants['DISCHARGED']
...
class RobotStatus(metaclass=Metaclass_RobotStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.collision_force = kwargs.get('collision_force', float())
    ...
    def __eq__(self, other):
        ...
        if self.battery_level != other.battery_level:
            return False
        if self.collision_force != other.collision_force:
            return False
        return True
    ...
    @builtins.property
    def collision_force(self):
        """Message field 'collision_force'."""
        return self._collision_force

    @collision_force.setter
    def collision_force(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'collision_force' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'collision_force' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._collision_force = value
