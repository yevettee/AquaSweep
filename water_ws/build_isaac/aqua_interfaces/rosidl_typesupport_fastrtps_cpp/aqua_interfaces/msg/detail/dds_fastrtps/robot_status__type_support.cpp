...
#include "aqua_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aqua_interfaces::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aqua_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aqua_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &aqua_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
