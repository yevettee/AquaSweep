...
static const _TankPhysicalVariables_type_support_symbol_names_t _TankPhysicalVariables_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aqua_interfaces, msg, TankPhysicalVariables)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aqua_interfaces, msg, TankPhysicalVariables)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aqua_interfaces, msg, TankPhysicalVariables)() {
  return &::aqua_interfaces::msg::rosidl_typesupport_c::TankPhysicalVariables_message_type_support_handle;
}
